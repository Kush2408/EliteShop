    ...
    >
      ...
      <div className="w-full md:w-1/2 z-10 space-y-6">
        <motion.span
          ...
          className="inline-block text-sm font-medium tracking-widest uppercase text-blue-500 bg-blue-100 dark:text-blue-300 dark:bg-blue-950/30 px-4 py-1 rounded-full shadow-md transition"
        >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-sky-400 to-purple-400 dark:from-blue-300 dark:via-sky-300 dark:to-purple-300"
        >
        ...
        <motion.p
          ...
          className="text-lg font-medium text-blue-500 dark:text-blue-300 tracking-wide"
        >
        ...
        >
          <Link
            ...
            className="inline-block bg-gradient-to-r from-blue-400 to-purple-400 dark:from-blue-500 dark:to-purple-500 text-white px-6 py-3 rounded-full font-semibold shadow-md hover:shadow-2xl transform hover:scale-105 transition duration-300"
          >
        ...
        <motion.ul
          ...
          className="flex flex-wrap gap-4 pt-4 text-sm font-medium text-blue-400 dark:text-blue-300"
        >
          {[
            { label: "🚚 Free Shipping" },
            { label: "📦 Easy Returns" },
